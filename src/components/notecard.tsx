...
export function Notecard({ note, handleNoteDelete }: NotecardProps) {
  return (
    <Dialog.Root>
      <Dialog.Trigger className=" flex flex-col outline-none rounded-md text-left bg-slate-800 p-5 gap-3 overflow-hidden relative hover:ring-2 hover:ring-slate-600 focus:ring-2 focus:ring-lime-400">
